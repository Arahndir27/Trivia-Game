<template>
  <div class="page">
    <h1>Suggest More Trivia!</h1>

    <form class="input-form" v-on:submit.prevent="addSuggestion">
      <input class="input-box" v-model="suggestion" />
      <button class="button-82-pushable submit" role="button" type="submit">
